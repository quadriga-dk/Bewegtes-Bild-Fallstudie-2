...
Ausgangspunkt für den Import in Excel ist die Datei *Synthetischer_Datensatz_Auswertung_OER.tsv* **[Link einfügen!]**. Die tsv-Datei weist vor dem eigentlichen Datensatz eine Zeile mit dem Hinweis auf, dass es sich um einen synthetischen Datensatz für Unterrichtszwecke handelt, der keine personenbezogene Daten enthält. Diese erste Zeile muss vom Import ausgeschlossen werden. Nur dann werden die Daten mit den korrekten Spaltennamen richtig in die Datei übernommen. Hierfür sind folgende Excel-Einstellungen notwendig.
