...
Da der bereinigte Datensatz aus dem Bibliothekskatalog aus rechtlichen Gründen nicht veröffentlicht werden kann, wurden die Visualisierungen anhand eines [synthetischen Datensatzes](/bereinigung/openRefine/0_datenbereinigung.md) erstellt. Auf die Problemfelder, die bei der Publikation von Daten auftreten können, wird im [folgenden Kapitel](/publikation/toc.md) genauer eingegangen.
