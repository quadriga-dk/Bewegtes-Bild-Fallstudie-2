...
## Datenschutz-Grundverordnung (DSGVO) und personenbezogene Daten
...
* Die betroffenen Personen erteilen die Einwilligung zur Verarbeitung ihrer Daten. Für diese Einwilligung muss der genaue Zweck der Datenverarbeitung angegeben werden, ebenso die Art der Speicherung und Archivierung der Daten. Die Einwilligung muss freiwillig erfolgen und kann jederzeit widerrufen werden.
...
>Bei professionellen Film- oder Fernsehproduktionen wird man davon ausgehen können, dass die Interessen an der Findbarkeit solcher Inhalte die Interessen der Betroffenen überwiegen. Denn solche Personenangaben waren meist bereits öffentlich, bevor die Inhalte ins Archiv kamen. {cite}`h-Klimpel_Rack_2023`
...
Der urheberrechtliche Schutz gilt bis 70 Jahre nach dem Tod der/des Urhebers:in. Danach ist das Werk gemeinfrei und ohne Lizenz nutzbar. Bei Filmwerken zählt dabei der Tod der/des Regisseurs:in, des/der Drehbuchautors:in oder der/des Komponisten:in der Filmmusik. Maßgeblich ist dabei, wer von den gemeinsamen Urheber:innen am längsten lebt.
...
Miturheber:innen sind bei einem Film also alle, die bei der Entstehung schöpferisch beteiligt waren. Welche Funktionen und Gewerke als schöpferisch tätig gelten, ist dabei nicht klar festgelegt. Meist werden nach Paul Klimpel und Fabian Rack Regisseur:in, Kameraperson und Cutter:in (bzw. Editor:in) als Miturheber:in angesehen, eine feste Liste gibt es hierfür jedoch nicht {cite}`h-Klimpel_Rack_2023`.
