...
Wie diese Aufarbeitung geschieht und welche Vorannahmen, technischen Voraussetzungen oder pragmatischen Vorgehensweisen darin einfließen und diese prägen, gilt es zu verstehen und bei der Arbeit mit dem Datensatz zu beachten. In der bereits im Abschnitt zu Metadaten angesprochenen Studie zu heterogenen Metadaten am Beispiel von Lotte Reiniger kommen Pauline Junginger und Sarah-Mai Dang daher in ihrem Fazit zu dem Schluss:
...
Um die Struktur der Daten im OPAC und den Ablauf der Erfassung dieser Daten zu einem Film im Archiv der Filmuniversität besser zu verstehen, haben wir für die Fallstudie ein Gespräch über den Prozess der Eingabe der Daten mit der zuständigen Person in der Bibliothek geführt. Die folgenden Ausführungen beziehen sich u.a. auf dieses Gespräch. An dieser Stelle können nicht alle Felder, in denen Metadaten zu den Filmen aufgeführt sind, besprochen werden. Der Fokus liegt v.a. auf denen, die häufig auftreten und die für die Bearbeitung der im [vorigen Kapitel](/recherche/operationalisierung.md) erarbeiteten (Teil)fragestellungen potenziell relevant sind. Es soll ein Verständnis vermittelt werden, wie diese Metadaten in den OPAC und damit in unseren Datensatz aufgenommen wurden. Dadurch wollen wir eine Grundlage für deren kritische Auswertung legen.

### Erfassung der Daten
Bei den studentischen Filmen im Archiv handelt es sich zum großen Teil um Titel, die nur dort und in keinem anderen Archiv vorhanden sind. Es können also für die Katalogisierung meist keine Informationen aus externen Quellen übernommen werden, wie z.B. aus Datenbanken im Internet oder DVD-Covers. Die Daten für die Einträge in den OPAC werden in der Regel durch eine Sichtung des Films selbst abgenommen.[^1] Während der Sichtung werden diese in ein Formblatt eingetragen und anschließend in den OPAC übertragen. Neben den "verantwortlichen Personen", die dem jeweiligen Gewerk – also filmischen Arbeitsbereich – zugeordnet sind, werden Informationen wie Titel, Regie, Produktionsjahr oder Format in diesem Formblatt erfasst. Wichtig ist hierbei, dass die Reihenfolge der Gewerke nicht der Reihenfolge im Abspann des Films entspricht, sondern einer bibliotheksintern festgelegten einheitlichen Abfolge für alle Filme: Regie, Kamera, Produktion, Drehbuch, Dramaturgie, Montage / Schnitt, Ton (Sound), Mischung, Musik, Szenografie, Herstellungsleitung, Darsteller, thematisierte Person, fachliche Beratung. Diese erscheint größtenteils später auch in der Anzeige des OPACs, es finden sich jedoch auch gelegentliche Abweichungen von dieser Reihenfolge. Die Prozesse bei der Eingabe der Daten beeinflussen hier die spezifische Art ihrer Anordnung in der Ausgabe im OPAC und in unserem Datensatz. Zusätzlich ist zu beachten, dass nicht immer alle Informationen zu den Metadaten eines Films vollständig vorliegen, also in diesem Fall bestimmte Eingabefelder nicht befüllt werden.
...
In einem weiteren Feld wird der Titel des Films genannt. Im Feld Zusatz sind die Projektarten der studentischen Filme aufgeführt, z.B. "Übung", "Diplomfilm", "Hauptprüfungsfilm" oder "F1", "F2", "F3" – was ebenfalls spezifische Filmübungen aus dem Lehrplan der Hochschule sind. Diese Projektarten können für die Auswertung der Metadaten im Rahmen unserer Fragestellung interessant sein. Gegebenenfalls werden die Übungen zusätzlich den Studiengängen zugeordnet, die hauptverantwortlich oder beteiligt waren. ({numref}`opac_titel`) Bei "Personenangaben" werden Einträge aus den Feldern "sonstige Personen" wiederholt, in der Regel die erste Zeile in Form der Regie und des entsprechenden Namens, gelegentlich finden sich mehrere Namensnennungen und Gewerke im selben Feld.
...
Die Einträge der Schlagworte im entsprechenden Feld folgen der <a href="https://server8.bibl.filmuniversitaet.de/F/6KHGSG35Q44ADGX7IRHFVI39NP3I8DT6BALDNVI8JP1FSFXJB1-07791?func=file&file_name=swt.html" class="external-link" target="_blank">Liste aller Schlagworte</a> der Universitätsbibliothek, die sich an der <a href="https://www.filmuniversitaet.de/fileadmin/user_upload/pdfs/bibliothek/schlagsys.pdf" class="external-link" target="_blank">Systematik</a> der Bibliothek orientiert. Es handelt sich um ein kontrolliertes Vokabular, da nur Begriffe vergeben werden können, die in der Liste aufgeführt sind. Anhand des Schlagworts wird auch die Gattung des Films charakterisiert – also Dokumentarfilm, Spielfilm oder Animationsfilm –, falls die Gattung bei der Eingabe erfasst wurde. Später sollen für unsere Fragestellung die Angaben zur Gattung und die weiteren erfassten Schlagworte ausgewertet werden. Diese können z.B. auf die in den Filmen behandelten Themen hinweisen. Im Datensatz müssen diese also wiederum als eigene, getrennte Zellen vorhanden sein.
...
:keyprefix: d-
```
[^1]:Für die Erfassung von Filmen, die vor 1989 entstanden sind, werden auch Informationen aus den Unterlagen der Öffentlichkeitsarbeit und der Produktion herangezogen. Allerdings sind nicht für alle studentischen Produktionen solche Unterlagen vorhanden.