...
Für die [Eingabe von *GREL*-Code](/bereinigung/openRefine/5.1_jahre.md#grel) mit *Regex*Mustern öffnen Sie wiederum das Dropdown-Menü einer Spalte, den Reiter *Edit cells* und *Transform…* und gelangen so in das das entsprechende Menü.
