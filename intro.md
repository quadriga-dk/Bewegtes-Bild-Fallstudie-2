...
:language: bibtex
```
Schick, T., Winter, M., Loist, S. & Gieseke, L. (2026). _Studentische Filme an der Filmuniversität Babelsberg zur Wendezeit (1985–1999)_. https://doi.org/10.5281/zenodo.19571422
...
- im **4. Schritt** steht der Weg zur Publikation der Daten im Mittelpunkt. Es wird auf den Stand des Forschungsdatenmanagements in der Filmwissenschaft und mögliche Problemfelder bei der Datenpublikation eingegangen (siehe Kapitel [Datenpublikation](publikation/toc)).
